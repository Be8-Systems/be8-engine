...
export default class Be8 {
    ...
    async getDerivedKey (publicKey, privateKey) {
        ...
        const publicKey = window.crypto.subtle.importKey(format, publicKey, algorithm, true, []);
        const privateKey = window.crypto.subtle.importKey(format, privateKey, algorithm, true, keyUsages);
